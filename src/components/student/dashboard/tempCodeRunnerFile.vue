        ...
        <div class="dashboard_ContainerFluid">
            <div class="row flex-nowrap">
                ...
                <div class="col custom-scrollbar justify-content-center overflow-scroll flex-nowrap">
                    ...
                    <p class="lead mt-5 text-muted mx-4 fs-1 py-2 ">Graduate Admission </p>
                    <hr>
                    ...
                    <img src="../../../assets/img/itc-front-entrance.png" alt="" class="w-100 m-auto img-fluid h-100">

                    <div class="mt-3 d-flex justify-around ">
                        ...
                        <router-link :to="{ name: 'studentDocument', params: { userId: user.id } }"
                            ...
                            <button
                                ...
                                <span class="button-text mx-2">My Document</span>
                            </button>
                        </router-link>
                        ...
                        <router-link :to="{ name: 'studentMyCourse', params: { userId: user.student_id } }"
                            class="text-decoration-none"> <button
                                ...
                                <span class="button-text mx-2">My Course Program</span>
                            </button>
                        </router-link>
                    </div>
