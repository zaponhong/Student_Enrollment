...
<template>
  <div class="changePass_Container" v-if="user"></div>
  ...
  <div class="w-75 m-auto d-flex justify-content-around mt-3">
    ...
    <div class="changePass_textBox mt-3">
      <h6 class="text-uppercase fs-4 fw-bold mt-4">
        graduate school of the institute of technology of cambodia
      </h6>
    </div>
  </div>

  <div class="w-50 m-auto text-center mt-5 py-4">
    <h6 class="text-uppercase fs-4">Change New Password</h6>
  </div>

  <form
    class="changePass_Form border border-top-0 align-items-center d-flex flex-column justify-content-center bg-white rounded-5 w-75 m-auto py-1 gap-2"
    @submit.prevent="changePassword">
    <div class="changePass_Input form-outline mb-2 w-75 m-auto d-flex position-relative flex-column">
      <label class="changePass_Label" for="password_field">Old Password</label>
      <svg fill="none" viewBox="0 0 24 24" height="24" width="24" xmlns="http://www.w3.org/2000/svg"
        class="changePass_Icon position-absolute">
      ...
      <input placeholder="password" title="Inpit title" name="input-name" type="password"
        class="changePass_Field rounded-3 border-1 outline-none" v-model="currentPassword" id="password_field"
        required="" />
    </div>

    <div class="changePass_Input form-outline mb-2 w-75 m-auto d-flex position-relative flex-column">
      <label class="changePass_Label" for="password_field">New Password</label>
      <svg fill="none" viewBox="0 0 24 24" height="24" width="24" xmlns="http://www.w3.org/2000/svg"
        class="changePass_Icon position-absolute">
        <path stroke-linecap="round" stroke-width="1.5" stroke="#141B34"
          d="M18 11.0041C17.4166 9.91704 16.273 9.15775 14.9519 9.0993C13.477 9.03404 11.9788 9 10.329 9C8.67911 9 7.18091 9.03404 5.70604 9.0993C3.95328 9.17685 2.51295 10.4881 2.27882 12.1618C2.12602 13.2541 2 14.3734 2 15.5134C2 16.6534 2.12602 17.7727 2.27882 18.865C2.51295 20.5387 3.95328 21.8499 5.70604 21.9275C6.42013 21.9591 7.26041 21.9834 8 22">
      ...
      <input placeholder="password" title="Inpit title" name="input-name" type="password"
        class="changePass_Field rounded-3 border-1 outline-none" v-model="newPassword" id="password_field" required="" />
    </div>

    <div class="changePass_Input form-outline mb-2 w-75 m-auto d-flex position-relative flex-column">
      <label class="changePass_Label" for="password_field">Confirm New Password</label>
      <svg fill="none" viewBox="0 0 24 24" height="24" width="24" xmlns="http://www.w3.org/2000/svg"
        class="changePass_Icon position-absolute">
        <path stroke-linecap="round" stroke-width="1.5" stroke="#141B34"
          d="M18 11.0041C17.4166 9.91704 16.273 9.15775 14.9519 9.0993C13.477 9.03404 11.9788 9 10.329 9C8.67911 9 7.18091 9.03404 5.70604 9.0993C3.95328 9.17685 2.51295 10.4881 2.27882 12.1618C2.12602 13.2541 2 14.3734 2 15.5134C2 16.6534 2.12602 17.7727 2.27882 18.865C2.51295 20.5387 3.95328 21.8499 5.70604 21.9275C6.42013 21.9591 7.26041 21.9834 8 22">
      ...
      <input placeholder="confirm new password" title="Inpit title" name="input-name" type="password"
        class="changePass_Field rounded-3 border-1 outline-none" v-model="newPasswordConfirmation" id="password_field"
        required="" />
    </div>

    <router-link v-bind:to="'/forgotPass'" class="mt-3 text-decoration-none" style="margin-left: 50%;">
      <p class="m-auto mb-3">Forgot your password?</p>
    </router-link>

    <router-link :to="{ name: 'studentProfile', params: { userId: user.student_id } }"
      class="changePass_Btn m-auto outline-none text-white rounded-3 border-0 w-75 mb-4 text-center">
      <button title="Sign In" type="submit"
        class="changePass_Btn m-auto outline-none text-white rounded-3 border-0 w-75 mb-4">
